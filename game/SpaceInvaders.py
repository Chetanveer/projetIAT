...
class SpaceInvaders():
    ...
    def __init__(self, display: bool = False):
        ...
        pygame.display.set_caption(
            "Welcome to Space Invaders Game by:- styles")
    ...
    def get_state(self):
        ...
        stateVect = [x_p, x_invader, bulletState]
        return stateVect
    ...
    def reset(self):
        ...
        for _ in range(SpaceInvaders.NO_INVADERS):
            self.invaderImage.append(
                pygame.image.load(getURL('data/alien.png')))
    ...
    def step(self, action):
        ...
        for i in range(SpaceInvaders.NO_INVADERS):
            ...
            collision = self.isCollision(
                self.bullet_X, self.invader_X[i], self.bullet_Y, self.invader_Y[i])
            if collision:
                reward = 1
                self.score_val += 1
                self.bullet_Y = 600
    ...
    def show_score(self, x, y):
        score = self.font.render(
            "Points: " + str(self.score_val), True, (255, 255, 255))
